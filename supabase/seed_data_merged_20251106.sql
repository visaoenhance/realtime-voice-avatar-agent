-- Combined seed for Food Court (profiles + menu/cart samples) - 2025-11-06

insert into fc_profiles (id, household_name, default_layout, current_layout, default_location)
values (
