      ...
      items: [
        {
          ...
          description: 'Tropical key lime cheesecake with coconut graham crust. No chocolate.',
          price: 8.99,
          rating: 4.9,
          tags: ['Tropical', 'No Chocolate'],
          image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?auto=format&fit=crop&w=800&q=80',
        },
        {
          slug: 'coconut-cheesecake',
          name: 'Coconut Cheesecake',
          description: 'Creamy coconut cheesecake with toasted coconut flakes',
          price: 8.49,
          rating: 4.7,
          tags: ['Tropical', 'No Chocolate'],
        },
      ...
      items: [
        {
          ...
          description: 'Rich and creamy vanilla cheesecake with graham cracker crust. No chocolate.',
          price: 7.99,
          rating: 4.8,
          tags: ['No Chocolate'],
        ...
        },
        {
          ...
          description: 'Vanilla cheesecake topped with fresh strawberries and strawberry sauce',
          price: 8.99,
          rating: 4.7,
          tags: ['Fresh Fruit', 'No Chocolate'],
        },
        {
          slug: 'lemon-cheesecake',
          name: 'Lemon Cheesecake',
          description: 'Tangy lemon cheesecake with a hint of lime zest. Light and refreshing.',
          price: 8.49,
          rating: 4.6,
          tags: ['Citrus', 'No Chocolate'],
        },
        {
          slug: 'cannoli',
          name: 'Cannoli',
          description: 'Traditional Italian cannoli filled with sweet ricotta cream',
          price: 5.99,
