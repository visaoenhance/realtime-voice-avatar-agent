      ...
      <header className="border-b border-zinc-900/80 bg-black/40">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-8">
            <Link href="/" className="font-display text-3xl text-netflix-red tracking-[0.35em]">
              MovieNite
            </Link>
            <nav className="hidden gap-5 text-xs font-semibold uppercase tracking-[0.4em] text-netflix-gray-300 md:flex">
              <Link href="/" className="transition hover:text-netflix-gray-100">
                Home
              </Link>
              <span className="text-white">Voice Concierge</span>
            </nav>
          </div>
